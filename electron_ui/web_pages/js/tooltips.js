...
function set_default_tooltips_settings(){
    ...
    set_tooltip("install_path",
        "Root path would be appended by:\n\\AnsysEM\\v2XX for Electronics Desktop\n" +
        "or \n\\ANSYS Inc\\vXXX for Workbench");

    set_tooltip("license_file",
        "License file path is required only for update of License Manager");

    set_tooltip("wb_assoc",
        "Set file associations to another release (e.g. official).\n" +
        "This will associate and open all Ansys Project files with selected release.\n" +
        "Set path to required WB version, ex: C:\\Program Files\\ANSYS Inc\\v212");
}

function set_default_tooltips_aedt_options() {
